@php
    ...
    $totalIbu = $patients->where('kategori', 'ibu')->count();
    $totalBalita = $patients->where('kategori', 'balita')->count();
@endphp
@extends('layouts.app')
...
@section('content')
        ...
        <div class="topbar">
            ...
            <div class="admin-badge">
                <img class="admin-avatar-img" src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?auto=format&fit=crop&w=80&h=80&q=80" alt="Admin" style="width: 40px; height: 40px; border-radius: 50%; object-fit: cover;" />
        ...
        <div class="stats-row grid grid-cols-3 gap-5 mb-7">
            ...
            <div class="stat-card">
                ...
                <div class="stat-info">
                    ...
                    <div class="stat-value">{{ number_format($totalIbu) }}</div>
                </div>
            </div>
        </div>
